...
if __name__ == '__main__':
    ...
    if args.test:
        # without GPS
        # path = '/data/qiwei/nips25/CVLnet2/ModelsKitti/3DoF/Stage1/lat20.0m_lon20.0m_rot10.0_Nit1_TransV1_geo_Level1_Channels32_16_4_Share_feat32_depth/model_9.pth'
        # with GPS
        path = '/data/qiwei/nips25/CVLnet2/ModelsKitti/3DoF/Stage1/lat20.0m_lon20.0m_rot10.0_Nit1_TransV1_geo_Level1_Channels32_16_4_GPSerror5_Coe1.0_Share_feat32_depth_GPS/model_9.pth'
        ...
        if args.resume:
            ...
            for k, v in pretrained_dict.items():
                if k in model_dict and v.shape == model_dict[k].shape:
                    ...
                    print(f"Skipping {k} due to shape mismatch: pretrained {v.shape} vs current {model_dict[k].shape}")
            ...
            path = '/data/qiwei/nips25/CVLnet2/ModelsKitti/3DoF/Stage0/lat20.0m_lon20.0m_rot10.0_Nit1_TransV1_geo_Level1_Channels32_16_4_feat32/model_4.pth'
        ...
        if args.visualize:
            model_path = os.path.join(save_path, 'model_2.pth')
